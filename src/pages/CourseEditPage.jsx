...
export const CourseEditPage = () => {
  ...
  if (error) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-8 bg-black min-h-screen text-white">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
            <div>
              <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400 mb-2">{course.title}</h1>
        ...
        <div className="mb-8 border-b border-white/10">
          <div className="flex gap-8">
            <button
              ...
              className={`pb-3 px-1 border-b-2 transition-all text-sm font-medium flex items-center gap-2 ${

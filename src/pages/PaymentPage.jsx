    ...
    <div className="bg-black min-h-screen text-white pt-20 pb-12">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 transition-all duration-500 animate-in fade-in slide-in-from-bottom-4">
        ...
        <div className="mb-10 text-center">
            <div className="w-16 h-16 bg-gradient-to-tr from-green-400 to-green-600 rounded-2xl mx-auto flex items-center justify-center mb-6 shadow-2xl shadow-green-400/20">
                <Lock className="w-8 h-8 text-white" />
            </div>
          <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400 mb-2">Secure Checkout</h1>
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden">
              ...
              <div className="p-6">
                  ...
                  <div>
                    ...
                    {course.instructor && (
                      <p className="text-sm text-gray-400 flex items-center gap-1.5">
                        <span className="w-5 h-5 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center text-[10px] font-bold">
                ...
                <Button
                  ...
                  className="w-full bg-gradient-to-r from-green-600 to-green-500 hover:from-green-500 hover:to-green-400 text-white shadow-lg shadow-green-500/20 py-4 rounded-xl text-lg font-bold transition-all relative overflow-hidden group"
                >
                ...
                <div className="space-y-6">
                  ...
                  <div className="pt-6 border-t border-white/10">
                    <div className="flex items-center gap-3 bg-purple-500/10 p-4 rounded-xl border border-purple-500/20">
                        ...
                        <div>
                             <h4 className="text-sm font-bold text-purple-200">Instant Access</h4>
